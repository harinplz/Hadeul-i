<template>
  <b-container>
    ...
    <div class="col-md-12" id="parent-sticky">
      ...
      <div v-if="attractions.length > 0">
        ...
        <attraction-search-list
          :attractions="attractions" @moveCenter="moveCenter"
    ...
    >
        ...
        <b-input-group style="width:500px" prepend="주소">
        </b-input-group>
    </b-modal>
  </b-container>
</template>
  ...
  methods: {
    ...
    loadMarkers() {
        ...
        let markerInfo = {
          ...
          content: 
            '<div class="overlaybox">'+
              '<div id="overTitle">'+this.attractions[i].title+'</div>'+
              '<div>'+
      ...
      for (var i = 0; i < positions.length; i++) {
        ...
        //마커 클릭에 대한 이벤트..
        window.kakao.maps.event.addListener(marker, 'click', this.makeDetailModal(this, this.attractions[i]));
    ...
    makeDetailModal(thiz, attInfo){ //클릭 시 모달을 띄우는 이벤트 등록
      return function(){
        console.log(attInfo);
