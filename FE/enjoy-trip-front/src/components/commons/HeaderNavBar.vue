  ...
  <div class="shadow-sm p-3 mb-5 bg-white rounded">
    ...
    <b-navbar toggleable="lg" type="light">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          <b-nav-item>
            <router-link class="nav_item" :to="{ name: 'home' }">HOME</router-link>
          </b-nav-item>
          <b-nav-item>
            <router-link class="nav_item" :to="{ name: 'attractions' }">관광지 조회</router-link>
          </b-nav-item>
          <b-nav-item class="nav_item">여행 계획</b-nav-item>
          <b-nav-item>
